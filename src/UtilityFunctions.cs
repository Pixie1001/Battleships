...
namespace battleship {
    public static class UtilityFunctions {
        public readonly static int FIELD_TOP = 122;
        public readonly static int FIELD_LEFT = 349;
        public readonly static int FIELD_WIDTH = 418;
        public readonly static int FIELD_HEIGHT = 418;

        public readonly static int MESSAGE_TOP = 548;

        public readonly static int CELL_WIDTH = 40;
        public readonly static int CELL_HEIGHT = 40;
        public readonly static int CELL_GAP = 2;

        public readonly static int SHIP_GAP = 3;
        ...
        public static int ANIMATION_CELLS = 7;
            ...
            for (int row = 0; row <= 9; row++) {
                ...
                for (int col = 0; col <= 9; col++) {
                    ...
                    switch (grid.Item(row, col)) {
                        //CHANGE Delete a case here Ship - might be relevant if the game crashes
                        case TileView.Miss: {
                                if (small)
