...
namespace battleship {
    class UtilityFunctions {
        public static int FIELD_TOP = 122;
        public static int FIELD_LEFT = 349;
        public static int FIELD_WIDTH = 418;
        public static int FIELD_HEIGHT = 418;

        public static int MESSAGE_TOP = 548;
